...
mixin _$SharedUser {
  String get userId =>
      throw _privateConstructorUsedError; // ID del usuario compartido
  bool get canAddItems => throw _privateConstructorUsedError;
...
abstract class $SharedUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userId, bool canAddItems});
}
    ...
    return _then(_value.copyWith(
      userId: null == userId
          ...
          : userId // ignore: cast_nullable_to_non_nullable
              as String,
      canAddItems: null == canAddItems
          ? _value.canAddItems
          : canAddItems // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$SharedUserImpl implements _SharedUser {
  const _$SharedUserImpl({required this.userId, required this.canAddItems});
  ...
  @override
  final String userId;
// ID del usuario compartido
  @override
  final bool canAddItems;

  @override
  String toString() {
    return 'SharedUser(userId: $userId, canAddItems: $canAddItems)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.canAddItems, canAddItems) ||
                other.canAddItems == canAddItems));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, userId, canAddItems);
...
abstract class _SharedUser implements SharedUser {
  const factory _SharedUser(
      ...
      required final bool canAddItems}) = _$SharedUserImpl;

  factory _SharedUser.fromJson(Map<String, dynamic> json) =
      _$SharedUserImpl.fromJson;

  @override
  String get userId; // ID del usuario compartido
  @override
