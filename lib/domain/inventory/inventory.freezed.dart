...
mixin _$Inventory {
  ...
  String get adminId =>
      throw _privateConstructorUsedError; // ID del usuario creador (admin)
// Atributos extra definidos para los items
  List<String> get extraAttributes => throw _privateConstructorUsedError;
  List<Item> get items =>
      throw _privateConstructorUsedError; // Lista de items del inventario
...
abstract class _Inventory implements Inventory {
  ...
  String get name;
  @override
  String get adminId; // ID del usuario creador (admin)
// Atributos extra definidos para los items
  @override
  List<String> get extraAttributes;
  @override
  List<Item> get items; // Lista de items del inventario
  @override
  List<SharedUser> get sharedUsers;
