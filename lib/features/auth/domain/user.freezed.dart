...
mixin _$User {
  ...
  List<String> get ownedInventories => throw _privateConstructorUsedError;
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, ownedInventories: $ownedInventories, sharedInventories: $sharedInventories)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      final List<String> sharedInventories}) = _$UserImpl;
